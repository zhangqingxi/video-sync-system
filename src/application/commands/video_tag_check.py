...
class VideoTagCheckCommand(BaseCommand):
    ...
    def execute(self) -> int:
        ...
        try:
            ...
            # 获取待检查的视频列表
            videos: list[dict[str, Any]] = video_repo.get_videos_after_id(last_id=last_checked_id, limit=10000)
            if not videos:
            ...
            with ThreadPoolExecutor(max_workers=thread_count) as executor:
                ...
                for video_data in videos:
                    ...
                    future: Future[bool] = executor.submit(self._check_video, tag_repo, video_id)
